...
#  8) to login shell
# curl -O https://raw.githubusercontent.com/Fmstrat/pfSense-CE-Azure/master/2.4.5/azure-setup.sh
...
# udf.ko originally from https://download.freebsd.org/ftp/releases/ISO-IMAGES/11.3/FreeBSD-11.3-RELEASE-amd64-bootonly.iso
curl -O https://raw.githubusercontent.com/Fmstrat/pfSense-CE-Azure/master/2.4.5/udf.ko
